...
(function() {
  ...
  /**
   * Function to update the stock image based on the company selection
   */
  const updateImage = () => {
  ...
  /**
   * Function to update the volatility image based on the volatility selection
   */
  const updateVolatilityImage = () => {
    ...
    switch (selectedValue) {
      case "apple":
        image.src = "assets/img/Stocks/Volatility/apple.png";
        break;
      case "microsoft":
        image.src = "assets/img/Stocks/Volatility/microsoft.png";
        break;
      case "netflix":
        image.src = "assets/img/Stocks/Volatility/netflix.png";
        break;
      case "google":
        image.src = "assets/img/Stocks/Volatility/google.png";
        break;
      default:
        image.src = "";
        break;
